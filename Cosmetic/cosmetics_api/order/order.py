from Cosmetic.models import Order, Item
from Cosmetic.schemas import OrderOut, ItemOut, MessageOut, CreateItem
...
def checkout_order(request):
    ...
    order.save()
    user_items = user.items.filter(checked=False, ordered=True)
